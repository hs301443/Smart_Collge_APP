...
import { signup,completeProfileStudent ,verifyEmail, login,resetPassword,verifyResetCode,sendResetCode, getFcmToken, completeProfile,updateProfileImage} from '../../../controller/users/auth';
...
route.post("/complete-student" ,catchAsync(completeProfileStudent))
